...
.DATA
     ...
     intro_b2d db "BINARY TO DECIMAL CONVERTER$"
     intro_b2h db "BINARY TO HEXA-DECIMAL CONVERTER$"
     intro_b2o db "BINARY TO OCTAL CONVERTER$"   
     intro_d2b db "DECIMAL TO BINARY CONVERTER$"
     intro_d2h db "DECIMAL TO HEXA-DECIMAL CONVERTER$"
     intro_d2o db "DECIMAL TO OCTAL CONVERTER$"  
     intro_h2b db "HEXA-DECIMAL TO BINARY CONVERTER$"
     intro_h2d db "HEXA-DECIMAL TO DECIMAL CONVERTER$"
     intro_h2o db "HEXA-DECIMAL TO OCTAL CONVERTER$"   
     intro_o2b db "OCTAL TO BINARY CONVERTER$"
     intro_o2d db "OCTAL TO DECIMAL CONVERTER$"
     intro_o2h db "OCTAL TO HEXA-DECIMAL CONVERTER$"         
     limit_bi db "THIS PROGRAM CAN CONVERT UPTO 15-BIT BINARY VALUE$" 
     limit_dec db "THIS PROGRAM CAN CONVERT UPTO 32767 DECIMAL VALUE$"  
     limit_hex db "THIS PROGRAM CAN CONVERT UPTO 7FFF HEXA-DECIMAL VALUE$"
     limit_oct db "THIS PROGRAM CAN CONVERT UPTO 77777 OCTAL VALUE$"  
     input_bi db "Insert a binary value: $"
     input_dec db "Insert a decimal value: $"
     input_hex db "Insert a hexa-decimal value: $"
     input_oct db "Insert an octal value: $"                                                  
     output_bi db "Binary equivalent value is: $"                                              
     output_dec db "Decimal equivalent value is: $"
     output_hex db "Hexa-decimal equivalent value is: $"
     output_oct db "Octal equivalent value is: $"     
     wrong_input_str db "Please insert valid inputs only.$"
...
.CODE
     ...
     input_loop_d2b2h:
          ...
          int 21h         
          cmp al,0dh
          je exit_input_loop_d2b2h
          sub al,30h
          cmp al,0
          jl invalid_input_d2b2h
          cmp al,9
          jle proper_d2b2h
          jg invalid_input_d2b2h
          proper_d2b2h:
          mov ah,0
          push ax
          inc len
     ...
     clear_stacK_d2b2h:
     pop dx
     loop clear_stack_d2b2h
     jmp error
          
     exit_input_loop_d2b2h:
      
     d2b_later_b2h_conversion:
     ...
     inserted_value_assign_d2b_later_b2h:
     cmp len,0
     ...
     dec bx
     mov si,bx
     assign_d2b_later_b2h:
          pop bx
          mov dec_arr[si],bl
          dec si
          loop assign_d2b_later_b2h
     ...
     assigned_decimal_calculation_loop_d2b_later_b2h:
     
          mov dl,[si]
          mov dh,0
          mov temp,dx
          cmp si,offset
          jg exit_assigned_decimal_calculation_loop_d2b_later_b2h
          mov ax,1
          mov cx,bx
          cmp cx,0
          je ten_power_zero_d2b_later_b2h
          jmp multiply_d2b_later_b2h
          ten_power_zero_d2b_later_b2h:
               mov ax,1
               jmp LSB_done_d2b_later_b2h
          
          multiply_d2b_later_b2h:
               mul ten
               cmp dx,0
               jne range_out_of_bound
               loop multiply_d2b_later_b2h     
          
          LSB_done_d2b_later_b2h:
          mul temp
          dec bx
          
          adding_d2b_later_b2h:
               add sum,ax
               cmp sum,0
               jl range_out_of_bound
          
          inc si
          jmp assigned_decimal_calculation_loop_d2b_later_b2h               
     
     exit_assigned_decimal_calculation_loop_d2b_later_b2h:
     
     cmp sum,0
     jl range_out_of_bound
     
     hexa_decimal_calculation_loop_d2h:
     
          mov dl,[si]
          mov dh,0
          mov temp,dx
          cmp si,offset
          jg exit_hexa_decimal_calculation_loop_d2h
          mov ax,1
          mov cx,bx
          cmp cx,0
          je two_power_zero_d2h
          jmp multiply_d2h
          two_power_zero_d2h:
               mov ax,1
               jmp LSB_done_d2h
          ...
          inc si
          jmp hexa_decimal_calculation_loop_d2h                 
     
     exit_hexa_decimal_calculation_loop_d2h:
     ...
     cmp len,0
     je exit_octal_calculation_loop_h2o  ;; note here
